...
public class Day08 implements AdventOfCodeSolution {
    ...
    public void runPart1(List<String> input) {
        ...
        var end = Instant.now();
        LOGGER.info(
                "The number of characters of code: {} minus the number of characters in memory {} in the whole file is: {}",
                code.get(), memory.get(), total);
    ...
    public void runPart2(List<String> input) {
        ...
        var end = Instant.now();
        LOGGER.info(
                "The number of characters in new string: {} minus the number of characters of code in old string {} in the whole file is: {}",
                newCode.get(), code.get(), total);
        logTimings(LOGGER, start, end);
    }
