 ...
 *
 * <p><br>
 * "Oh, that machine is quite old!", they tell you. "That model went out of support six
 * minutes ago, and we just finished shredding all the manuals. I bet we can find you the
 * code generation algorithm, though."
 *
 * <p><br>
 * After putting you on hold for twenty minutes (your call is very important to them,
 * it reminded you repeatedly), they finally find an engineer that remembers how the code
 * system works.
 *
 * <p><br>
...
public class Day25 implements AdventOfCodeSolution {
  ...
  public void runPart1(List<String> input) {
    ...
    var end = Instant.now();
    LOGGER.info("The code found at row {} and column {} is: {}",
  ...
  public void runPart2(List<String> input) {
    var start = Instant.now();
    var end = Instant.now();
    LOGGER.info("Happy Advent of Code 2015!!");
    logTimings(LOGGER, start, end);
  }
