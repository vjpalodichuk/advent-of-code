package com.capital7software.aoc.aoc2015aoc;
...
public class AdventOfCode2015Runner extends AdventOfCodeRunner {
   ...
   *             The first parameter must be a AdventOfCodeSolution class.
   */
  public static void main(String[] args) {
    var packageName = "com.capital7software.aoc.aoc2015aoc.days.";
