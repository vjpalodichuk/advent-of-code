 ...
 * edge of the grid might have fewer than eight neighbors; the missing ones always count as "off".
 *
 * <p><br>
 ...
 *     </li>
 *     <li>
 *         All the lights update simultaneously; they all consider the same current state before
 *         moving to the next.
 *     </li>
 * </ul>
 ...
 * wrong with the grid of lights you bought: <b>four lights, one in each corner, are stuck on and
 * can't be turned off.</b>
 *
 * <p><br>
