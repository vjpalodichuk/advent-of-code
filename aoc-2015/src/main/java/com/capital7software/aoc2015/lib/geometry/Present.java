 ...
 * The elves also need a little extra paper for each present: the area of the smallest side. The elves also need
 * ribbon for each present along with enough to make a bow. The ribbon required to wrap a present is the shortest
 * distance around its sides, or the smallest perimeter of any one face. Each present also requires a bow made
 * out of ribbon as well; the feet of ribbon required for the perfect bow is equal to the cubic feet of volume
 * of the present.
 * <p>
