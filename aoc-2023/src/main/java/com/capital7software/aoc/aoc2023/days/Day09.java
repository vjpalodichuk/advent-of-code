 ...
 * up the sand, you might be able to use the glider and the hot air to get all the way up to
 * the metal island!
 *
 * <p><br>
 ...
 * by 3 each step, the first sequence of differences that you generate will be 3 3 3 3 3. Note
 ...
 * each previous sequence, you should instead add a zero to the beginning of your sequence of
...
public class Day09 implements AdventOfCodeSolution {
  ...
  /**
   * Returns the sum of the previous predicted value for all HistorySequences in the specified
   * input.
   *
   * @param input The List of Strings of histories to parse and load.
