 ...
 * You reach the place where all the mirrors were pointing: a massive parabolic reflector dish attached to
 * the side of another large mountain.
 * <p><br>
 * The dish is made up of many small mirrors, but while the mirrors themselves are roughly in the shape of
 * a parabolic reflector dish, each individual mirror seems to be pointing in slightly the wrong direction.
 * If the dish is meant to focus light, all it's doing right now is sending it in a vague direction.
 * <p><br>
 * This system must be what provides the energy for the lava! If you focus the reflector dish, maybe you
 * can go where it's pointing and use the light to fix the lava production.
 * <p><br>
