...
public class Day08 implements AdventOfCodeSolution {
  ...
  /**
   * Calculates and returns the number of steps to traverse the network from a single starting
  ...
  /**
   * Calculates and returns the number of steps to traverse the network from multiple starting
