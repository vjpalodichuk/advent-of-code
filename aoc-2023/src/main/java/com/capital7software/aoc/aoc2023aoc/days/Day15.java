 ...
 * The newly-focused parabolic reflector dish is sending all the collected light to a point
 * on the side of yet another mountain - the largest mountain on Lava Island. As you approach
 ...
 * smaller sign that says "Danger - Personal Protective Equipment required beyond this point".
 *
 * <p><br>
 ...
 * hard hats (you quickly find some that fit) and then further into the facility. At one point,
 * you pass a button with a faint snout mark and the label "PUSH FOR HELP". No wonder you were
 ...
 * what must be the room that collects all the light from outside. As you admire the large
 * assortment of lenses available to further focus the light, the reindeer brings you a book
 * titled "Initialization Manual".
 *
 * <p><br>
 * "Hello!", the book cheerfully begins, apparently unaware of the concerned reindeer reading
 * over your shoulder. "This procedure will let you bring the Lava Production Facility
 * online - all without burning or melting anything unintended!"
 *
 * <p><br>
