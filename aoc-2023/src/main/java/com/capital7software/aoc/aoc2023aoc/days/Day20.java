 ...
 * With your help, the Elves manage to find the right parts and fix all the machines. Now, they
...
public class Day20 implements AdventOfCodeSolution {
  ...
  public void runPart1(List<String> input) {
    ...
    LOGGER.info(
        "The product of the low and high pulses after 1,000 button presses is: {}", answer
    );
  ...
  public void runPart2(List<String> input) {
    ...
    LOGGER.info(
        "The fewest number of button presses to deliver a low pulse to module rx is: {}", answer
    );
    logTimings(LOGGER, start, end);
  }
  ...
  /**
   * Returns the minimum number of button presses needed to send a low pulse to the specified
   * module. Or -1 if the maximum number of button presses was reached before a low pulse would
   * be sent to the specified module.
   *
   * @param input               The List of Strings to parse that define the workflows and part
   *                            ratings.
  ...
  public long getButtonPressesNeededToSendLowPulseToModule(
    ...
    var headquarters = CycleHeadquarters.buildCycleHeadquarters(input);
    return headquarters.buttonPressesNeededToSendLowPulseToModule(
        id, requiredSourceCount, maxButtonPresses
    );
  }
}
