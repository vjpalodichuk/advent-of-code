...
import com.capital7software.aoc.lib.analysis.PrintQueue
 ...
 * **What do you get if you add up the middle page numbers after correctly ordering just
 * those updates?**
 *
...
class Day05 : AdventOfCodeSolution {
  ...
  override fun runPart1(input: List<String>) {
    ...
    val elapsed = measureNanoTime {
      answer = sumOfValidMiddlePages(input)
    }
    log.info("$answer is the sum of the middle pages of the valid page updates!")
  ...
  override fun runPart2(input: List<String>) {
    var answer: Long
    val elapsed = measureNanoTime {
      answer = sumOfInvalidMiddlePages(input)
    }
    log.info("$answer is the sum of the middle pages of the invalid page updates after " +
                 "reordering to pass all of the rules!")
    logTimings(log, elapsed)
  }

  /**
   * Returns the sum of the middle pages of the valid page updates.
   *
   * @param input The list of strings to form the page ordering rules and page updates.
   * @return The sum of the middle pages of the valid page updates.
   */
  @SuppressFBWarnings
  fun sumOfValidMiddlePages(input: List<String>): Long {
    return PrintQueue(input).sumOfMiddlePagesOfValidPageUpdates()
  }

  /**
   * Returns the sum of the middle pages of the invalid page updates.
   *
   * @param input The list of strings to form the page ordering rules and page updates.
