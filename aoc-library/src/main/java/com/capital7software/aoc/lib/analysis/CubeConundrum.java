...
public record CubeConundrum() {
  ...
  public record GameResult(int id, @NotNull List<Reveal> reveals) {
    ...
    public int power() {
      if (reveals.isEmpty()) {
        throw new RuntimeException(
            "At least one reveal is required to calculate the power of this game");
      }
    ...
    public @NotNull Reveal findMinimumCubes() {
      if (reveals.isEmpty()) {
        throw new RuntimeException(
            "At least one reveal is required to find the minimum cubes of this game");
      }
    ...
    /**
     * Returns true if the set of cubes contain only 12 red cubes, 13 green cubes,
     * and 14 blue cubes.
     *
     * @return True if the set of cubes contain only 12 red cubes, 13 green cubes,
     *     and 14 blue cubes.
     */
