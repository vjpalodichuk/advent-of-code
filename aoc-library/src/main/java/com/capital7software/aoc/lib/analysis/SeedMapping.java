...
public class SeedMapping {
   ...
   * @return A new SeedMapping instance loaded with the Seeds and mappings from the List
   *     of input Strings.
   */
  public static @NotNull SeedMapping buildSeedMapping(@NotNull List<String> input) {
    ...
    final var processing = new AtomicReference<>("");
    ...
    input.forEach(it -> {
      ...
      if (it.startsWith(SEEDS_START)) {
        ...
        parseSeeds(it, seeds);
      } else if (it.startsWith(SEED_TO_SOIL_MAP_START)
          || processing.get().startsWith(SEED_TO_SOIL_MAP_START)) {
      ...
      } else if (it.startsWith(SOIL_TO_FERTILIZER_MAP_START)
          || processing.get().startsWith(SOIL_TO_FERTILIZER_MAP_START)) {
      ...
      } else if (it.startsWith(FERTILIZER_TO_WATER_MAP_START)
          || processing.get().startsWith(FERTILIZER_TO_WATER_MAP_START)) {
      ...
      } else if (it.startsWith(WATER_TO_LIGHT_MAP_START)
          || processing.get().startsWith(WATER_TO_LIGHT_MAP_START)) {
      ...
      } else if (it.startsWith(LIGHT_TO_TEMPERATURE_MAP_START)
          || processing.get().startsWith(LIGHT_TO_TEMPERATURE_MAP_START)) {
      ...
      } else if (it.startsWith(TEMPERATURE_TO_HUMIDITY_MAP_START)
          || processing.get().startsWith(TEMPERATURE_TO_HUMIDITY_MAP_START)) {
      ...
      } else if (it.startsWith(HUMIDITY_TO_LOCATION_MAP_START)
          || processing.get().startsWith(HUMIDITY_TO_LOCATION_MAP_START)) {
