 ...
 * </code>
 * This workflow is named ex and contains four rules. If workflow ex were considering a specific part, it would
...
public class WorkflowManager {
    ...
    private WorkflowManager(@NotNull Map<String, Workflow> workflowMap, @NotNull ConcurrentLinkedDeque<Part> parts) {
