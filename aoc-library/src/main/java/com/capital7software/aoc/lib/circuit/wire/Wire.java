...
/**
 * A Wire is capable of both consuming a Signal from a single source and supplying its Signal
 * to one or more consumers.
 *
 * <p><br>
 * A Wire's signal may be overridden by directly calling consume() on it and passing in the
 * desired Signal.
 *
 * <p><br>
 * A Signal is retrieved from its source automatically if supply() is called and the Signal
 * currently produced by this Wire is currently invalid.
 *
