...
public abstract class ArrayHeap<T> implements Heap<T> {
    ...
    public void heapify() {
        ...
        int n = numberOfItems, i = (n >>> 1) - 1; // Only do half!
    ...
    /**
     * Sorts the specified items array in reverse order so that the element with the maximum value is moved to the
     * end of the array and the first element in the array will have the minimum value.
     * <p>
    ...
    /**
     * Maintains the specified Heap by comparing the values of the parent and children and swapping them
     * when the children are not less than the parent. This process starts at the specified startIndex and
     * continues as long as a swap occurred or the endIndex has been reached.
     *
    ...
    /**
     * Similar to siftDown but starts with the child at endIndex and continues up to startIndex as long as a
     * swap of parent and child needs to be performed.
     *
