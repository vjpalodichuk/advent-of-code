...
public class HailStorm {
    ...
    /**
     * Returns the sum of the coordinates of the rock at its initial position that results in the rock
     * destroying every single hail stone!
     *
    ...
    private Plane findRock(@NotNull HailStone first, @NotNull HailStone second, @NotNull HailStone third) {
