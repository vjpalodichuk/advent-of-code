...
public class Lagoon {
  ...
  /**
   * Builds a new Lagoon from the specified dig plan and the digging starts at the specified point.
   * If colorsAsInstructions is true then the colors are decoded as digging instructions.
   *
   * @param initialVertex        The initial point to start digging.
   * @param input                The List of Strings that contain the dig plan to parse.
   * @param colorsAsInstructions If true, then the colors in the dig plan are decoded
   *                             as instructions.
