...
/**
 * A LineSegment2D represents a line between two Point2Ds. Supports points of various numeric data types.
 *
...
public record LineSegment2D<T extends Number & Comparable<T>>(
    ...
    /**
     * When this LineSegment2D and other LineSegment2D are on the same line and overlap, the point that
    ...
    /**
     * Assumes that other is collinear to this LineSegment2D and checks if other falls on this LineSegment2D
     *
    ...
    /**
     * Returns true if the start and end point of the other LineSegment2D is collinear to this LineSegment2D.
     *
