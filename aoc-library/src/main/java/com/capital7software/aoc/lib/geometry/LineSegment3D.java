...
/**
 * A LineSegment3D represents a line between two Point3Ds. Supports points of various numeric data types.
 *
...
public record LineSegment3D<T extends Number & Comparable<T>>(
    ...
    /**
     * Determines if this LineSegment3D is below the other LineSegment3D. This method does not consider the Z-axis when
     ...
     * @return If this LineSegment3D is below the other LineSegment3D, along the X-axis and Y-axis only, true is
