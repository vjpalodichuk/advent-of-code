...
public class Polygon2D<T extends Number & Comparable<T>> {
     ...
     * The order of the vertices and colors in the Lists is important as it determines the orientation
     * of this Polygon2D as well as the rendering order.
     *
    ...
    /**
     * Returns a LineSegment2D from the specified index to its neighbor. The index parameter must be a valid
     * index into the List of vertices.
     *
