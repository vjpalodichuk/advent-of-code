...
/**
 * Passed to the valid and invalid handlers of the PathFinder. Provides the details of the most recent path.
 *
 * @param id The ID of the path.
 * @param start The starting Vertex of the path.
 * @param end The last Vertex of the path. If this is a cycle, then there is an Edge in the end Vertex
