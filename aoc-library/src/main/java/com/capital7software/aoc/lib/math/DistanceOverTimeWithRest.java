...
/**
 * A simple record that can calculate distance traveled at time t given rate r the duration d
 * that can be traveled at a rate of r and the amount of rest u that is needed before traveling
 * at rate r again.
 *
 ...
 */
public record DistanceOverTimeWithRest(double rate, long duration,
                                       long rest) implements Comparable<DistanceOverTimeWithRest> {
  /**
   ...
   *
   * <p><br>
   * Where r is the rate of this object and dt is the amount of time spent traveling
   * for this object.
   *
   * <p><br>
