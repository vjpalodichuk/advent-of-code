...
public record Md5Fun() {
   ...
   * starts with five zeroes (000001dbbfa...), and it is the lowest such number to do so.<br><br>
   ...
   * @return The lowest positive number to join with the secret to produce a MD5 hash with the
   *     required number of leading zeros.
   */
  public static long lowestPositiveNumberWithLeadingZeros(
