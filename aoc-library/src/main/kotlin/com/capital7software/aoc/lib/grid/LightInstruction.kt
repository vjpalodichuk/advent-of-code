...
/**
 * A complete lighting instruction to apply to a grid. The two points are opposite corners of a
 * rectangle that this instruction applies to.
 *
 ...
 *               applies to.
 */
public record LightInstruction(LightInstructionType type, Point2D<Integer> point1,
                               Point2D<Integer> point2) {
  /**
