...
class JavaConventionPluginTest : PluginTest() {
    ...
    fun `fails on checkstyle error`() {
        testProjectDir.newFolder("src", "main", "java", "com", "capital7software")
        testProjectDir.newFile("src/main/java/com/capital7software/Foo.java").appendText("""
            package com.capital7software;
    ...
    fun `fails on checkstyle warning`() {
        testProjectDir.newFolder("src", "main", "java", "com", "capital7software")
        testProjectDir.newFile("src/main/java/com/capital7software/Foo.java").writeText("""
            package com.capital7software;
    ...
    fun `warns on deprecated API usage`() {
        ...
        testProjectDir.newFile("src/main/java/com/capital7software/Bar.java").writeText("""
            package com.capital7software;
