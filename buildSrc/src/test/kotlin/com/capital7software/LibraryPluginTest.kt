...
class LibraryPluginTest : PluginTest() {
    ...
    fun `publishes library with versioning`() {
        ...
        testProjectDir.newFile("src/main/java/com/capital7software/Util.java").writeText("""
            package com.capital7software;
        ...
        assertTrue(File(testProjectDir.getRoot(), "build/test-repo/com/capital7software/my-library/0.1.0/my-library-0.1.0.jar").exists())
    }
