...
configure<com.mooltiverse.oss.nyx.gradle.NyxExtension> {
  ...
  changelog {
    ...
    sections = mapOf(
        Pair("Added", "^(feat|:boom:|:sparkles:|:sparkle:|:pushpin:|:heavy_plus_sign:)$"),
  ...
  commitMessageConventions {
    ...
    items.create("conventionalCommitsForMerge") {
      expression = """(?<type>[a-zA-Z0-9_]+)(!)?(\((?<scope>[a-z ]+)\))?:( (?<title>.+))"""
